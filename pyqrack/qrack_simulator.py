...
class QrackSimulator:
    ...
    def __init__(self, qubitCount=-1, cloneSid=-1, isSchmidtDecompose=True, isStabilizerHybrid=True, is1QbFusion=True, isCpuGpuHybrid=True, pyzxCircuit=None):
        self.sid = None
        ...
        if cloneSid > -1:
            ...
            if qubitCount < 0:
                qubitCount = 0
            self.sid = Qrack.qrack_lib.init_count(qubitCount, isSchmidtDecompose, isStabilizerHybrid, is1QbFusion, isCpuGpuHybrid)
